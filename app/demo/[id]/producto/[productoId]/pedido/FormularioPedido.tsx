...
export default function FormularioPedido({ producto, siteId, productoId, primaryColor, tallaInicial, colorInicial }: { producto: any; siteId: string; productoId: string; primaryColor: string; tallaInicial?: string; colorInicial?: string }) {
  ...
  if (success) return (
    <div style={{ padding: "1rem", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: 300 }}>
      ...
      <Link href={`/demo/${siteId}/producto/${productoId}`} style={{ marginTop: "1.5rem", padding: "10px 24px", background: "#f3f4f6", border: "none", borderRadius: 10, cursor: "pointer", fontWeight: 600, textDecoration: "none", color: "#111" }}>Volver al producto</Link>
    </div>
  );
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <Link href={`/demo/${siteId}/producto/${productoId}`} style={{ flex: 1, padding: 14, background: "#f3f4f6", border: "none", borderRadius: 12, fontSize: "0.95rem", fontWeight: 600, cursor: "pointer", textAlign: "center", textDecoration: "none", color: "#111" }}>Atras</Link>
