    ...
    <div style={{ minHeight: "100vh", background: "#f8f9fa", fontFamily: font }}>
      {site.meta_pixel_id && (
        <Script id="fbq-checkout" strategy="afterInteractive">
          {
            "window.dmsPixelQueue = window.dmsPixelQueue || []; window.fbTrack = window.fbTrack || function(ev, params){ if (window.fbq) { window.fbq(" + String.fromCharCode(39) + "track" + String.fromCharCode(39) + ", ev, params || {}); } else { window.dmsPixelQueue.push([ev, params]); } }; window.fbTrack(" + String.fromCharCode(39) + "InitiateCheckout" + String.fromCharCode(39) + ", {content_name:" + String.fromCharCode(39) + (p.nombre ?? "").replace(/[\x27\x22]/g, "") + String.fromCharCode(39) + "});"
          }
        </Script>
      )}
