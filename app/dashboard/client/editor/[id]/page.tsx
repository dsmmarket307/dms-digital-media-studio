...
export default function EditorEmpresarial() {
  ...
  useEffect(() => {
    async function load() {
      ...
      if (sub?.plan !== "empresarial" || sub?.status !== "active") {
    ...
    <div style={{ height: "100vh", background: "#f0f0f0", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #e5e7eb", padding: "10px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <span style={{ fontSize: 11, background: "rgba(124,58,237,0.1)", color: "#7c3aed", padding: "2px 8px", borderRadius: 999, fontWeight: 700 }}>Empresarial</span>
        </div>
        <div style={{ display: "flex", gap: 6 }}>
