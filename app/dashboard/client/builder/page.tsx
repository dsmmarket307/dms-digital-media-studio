  ...
  return (
    <div style={{ height:"100vh", background:"#f0f0f0", display:"flex", flexDirection:"column", overflow:"hidden" }}>
      ...
      <div style={{ display:"flex", flex:1, minHeight:0 }}>
        ...
        <div style={{ flex: view === "desktop" ? 1 : "0 0 auto", width: view === "desktop" ? "auto" : `calc(${previewWidth} + 32px)`, overflowY:"auto", display:"flex", flexDirection:"column", alignItems:"center", padding:"16px", background:"#e0e0e0", gap:8 }}>
